...
class Settings(BaseSettings):
    ...
    local_job_claim_timeout_seconds: float = Field(default=5.0, gt=0, le=120)
    local_inference_timeout_seconds: float = Field(default=120.0, gt=0, le=600)
    chat_total_timeout_seconds: float = Field(default=180.0, gt=0, le=900)
    ...
    worker_heartbeat_timeout_seconds: int = Field(default=45, gt=0, le=3600)
